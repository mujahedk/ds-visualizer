...
/**
 * Props for the HeapView component
 */
 ...
 * @returns Rendered heap visualization
 */
const HeapView: React.FC<HeapViewProps> = ({ frame }) => {
  return (
    <div className="w-full h-full p-6">
      <div className="text-center mb-6">
        <div className="text-4xl mb-2">🌳</div>
        <h2 className="text-xl font-semibold text-white">Binary Heap</h2>
      ...
      <div className="bg-gray-700 rounded-lg p-4 mb-4">
        <h3 className="text-sm font-medium text-gray-300 mb-2">Heap State:</h3>
